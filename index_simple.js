...
(async () => {
  ...
  try {
    ...
    // Debug: ถ่ายภาพหน้าจอหลัง Login เพื่อดูว่าหน้าเว็บแสดงอะไร
    ...
    await page.waitForTimeout(15000); // รอ Dashboard โหลดกราฟให้เสร็จ (เพิ่มเวลารอ)

    // Debug: ถ่ายภาพหน้าจอหลังเปิด Dashboard
    ...
    // ลองหา selector ถ้าไม่เจอจะใช้ full page screenshot แทน
    ...
    // ส่งภาพ debug + ภาพจริง ไป Discord เพื่อตรวจสอบ
